...
<html lang="en">
    <head>
        ...
        <title>MeetAir - Flutter Video Conference App for Android And iOS</title>
        ...
        <div class="install-box">
            ...
            <div class="panel panel-install">
                <div class="panel-heading text-center">                    
                    <h2>MeetAir - Flutter Video Conference App for Android And iOS</h2>
                </div>
                <div class="panel-body no-padding">
                    ...
                    <div class="tab-content">
                                ...
                                <div class="section clearfix">
                                    ...
                                    <div>
                                        <div class="form-group clearfix">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" value="localhost" id="host"  name="host" class="form-control" placeholder="Database Host (usually localhost)" />
                                            </div>
                                        </div>
                                        <div class="form-group clearfix">
                        ...
                        <div role="tabpanel" class="tab-pane" id="finished-tab">
                            <div class="section">
                                <div class="clearfix">
                                    <i class="status fa fa-check-circle-o pull-left" style="font-size: 50px"> </i><span class="pull-left"  style="line-height: 50px;">Congratulation! You have successfully installed <strong>MeetAir - Flutter Video Conference App for Android And iOS</strong></span>  
                                </div>

                                <div style="margin: 15px 0 15px 60px; color: #d73b3b;">
                                    Don't forget to delete your installation directory from public_html!
                                </div>

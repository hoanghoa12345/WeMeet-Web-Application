...
<head>
  ...
  <title><?php echo get_app_config("app_name") ?> - Đăng nhập</title>
              ...
              <div class="col-lg-6">
                <div class="p-5">
                  <div class="text-center">
                    ...
                    <a href="<?php echo base_url(); ?>"><h1 class="h4 text-gray-900 mb-4"><?php echo get_app_config("app_name") ?> - Đăng nhập</h1></a>
                  </div>
                  ...
                  <hr>
                  <div class="text-center">
                    <a class="small" href="<?php echo base_url('forgot-password'); ?>">Quên mật khẩu?</a> |
                    <a class="small" href="<?php echo base_url('signup'); ?>">Tạo tài khoản</a>
                  </div>
                </div>
              </div>
            </div>
